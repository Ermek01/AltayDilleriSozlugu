...
//    }
    ...
    public void putListDescriptions(String key, ArrayList<ModelDescriptions> list){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ModelDescriptions descriptions: list){
            objStrings.add(gson.toJson(descriptions));
        }
        putListString(key, objStrings);
    }

    public ArrayList<ModelDescriptions> getListDescriptions(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ModelDescriptions> playerList =  new ArrayList<ModelDescriptions>();

        for(String jObjString : objStrings){
            ModelDescriptions player  = gson.fromJson(jObjString,  ModelDescriptions.class);
