...
//        chosenViewModel.addFavorite(code, ModelFavorites(descriptions[position].id, userId, true))
//    }
//
//    override fun onRemoveFavoriteClick(position: Int) {
//        chosenViewModel.addFavorite(code, ModelFavorites(descriptions[position].id, userId, false))
//    }
...
//        //requireActivity().toast(getString(R.string.txt_success_add_favorite))
//    }
